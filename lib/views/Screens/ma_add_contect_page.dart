      ...
      children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  onFieldSubmitted: (value) async {
                    ...
                    File nImage = await Provider.of<ContactStorController>(
                            context,
                            listen: false)
                        .image!
            ...
            children: [
              IconButton(
                  onPressed: () => showDialog(
                        context: context,
                        builder: Provider.of<DateTimeController>(context,
                                listen: false)
        ...
        OutlinedButton(
          onPressed: () async {
            Directory? dir = await getExternalStorageDirectory();
            File nImage =
                await Provider.of<ContactStorController>(context, listen: false)
                    .image!
                    .copy("${dir!.path}/$_name.jpg");
            if (formKey.currentState!.validate()) {
              formKey.currentState!.save();
